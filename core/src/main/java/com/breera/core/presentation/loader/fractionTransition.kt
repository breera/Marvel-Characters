...
/**
 * This file contains a custom Composable function for creating an infinite fraction transition.
 *
 * The `fractionTransition` function allows for a customizable animation that repeats indefinitely,
 * perfect for loaders, progress indicators, or any element that needs a bit of life.
 *
 * The `EaseInOut` value at the bottom is a custom easing curve that provides a smooth transition effect,
 */
@Composable
